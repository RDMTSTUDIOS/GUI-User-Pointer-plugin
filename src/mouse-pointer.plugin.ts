...
export class GUIUserPointerPlugin implements GUIPointer {
    ...
    private constructor(pointersGUILayer: HTMLElement, pointer_marker: string, x_delta: number = 0, y_delta: number = 0) {
        ...
        this.stopRendering = () => cancelAnimationFrame(renderStopFlag);
    ...
    // @sysfunc
    private readonly startRendering: () => void = () => undefined;
    // @sysfunc
    private readonly stopRendering: () => void = () => undefined
    ...
    // @vent
    public onStartRendering: () => Promise<void> = () => Promise.resolve();
    // @vent
    public onStopRendering: () => Promise<void> = () => Promise.resolve();
     ...
     */
    public show(): void {
        this.pointerGUIRoot.classList.add(staticStyling.GUI_hide)
    };
    ...
    */
    public hide(): void {
        this.pointerGUIRoot.classList.remove(staticStyling.GUI_hide)
    };
    ...
    */
    // @pattern(Proxy)
    public appendViews(...views: HTMLElement[]): void {
